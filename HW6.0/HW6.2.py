...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 14 02:57:38 2021
...
#RESHAPE
x_train = x_train.reshape(NKEEP,PIX,PIX); #print(X[0])
X1=X1.reshape(NKEEP,PIX,PIX); #print(X[0])
...
save_model('HW6.2-model.h5')
model = get_model('HW6.2-model.h5')
model.summary()
history.history
...
#RESHAPE
fX=fX.reshape(NKEEP,PIX,PIX); #print(X[0])
fx_pred=fx_pred.reshape(NKEEP,PIX,PIX); #print(X[0])
